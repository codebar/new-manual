    ...
    <>
      ...
      <SponsorSection>
        ...
        <PackagesWrapper>
          <Package>
            ...
            <PackageBenefits>
              <PackageBenefit>
                1 spot at a codebar workshop or event for your employees Your
                logo listed on top of our Sponsors page under Bronze tier
              </PackageBenefit>{' '}
              <PackageBenefit>
          ...
          <Package>
            ...
            <PackageBenefits>
              <PackageBenefit>
                3 spots at a codebar workshop or event for your employees 5
                minute lightning talk about your company, and what you do, at
                our weekly workshops Your logo printed on any marketing
                materials we produce (leaflets, flyers, etc.)
              </PackageBenefit>{' '}
              <PackageBenefit>
              ...
              <PackageBenefit>
                A blog post dedicated to your company and their support of
                codebar
              </PackageBenefit>
            </PackageBenefits>
          </Package>
          <Package>
            ...
            <PackageBenefits>
              <PackageBenefit>
                5 spots at a codebar workshop or event for your employees 5
                minute lightning talk about your company, and what you do, at
                our weekly workshops Your logo printed on any marketing
                materials we produce (leaflets, flyers, etc.)
              </PackageBenefit>{' '}
              ...
              <PackageBenefit>
                A blog post dedicated to your company and your support of
                codebar
              </PackageBenefit>
            </PackageBenefits>
          </Package>
      ...
      <SponsorSection>
        ...
        <InReturnText>
          ...
          their workshops Running more specialised events (all our events are
          free and run by volunteers - but we still need to handle food
          catering, marketing, planning and other administrative costs)
        </InReturnText>
        <SponsorTitles>What do you get in return?</SponsorTitles>
        <InReturnText>
          Whatever your investment, you can be proud knowing that you are an
          active member of this flourishing sector, enabling people to find
          jobs, enhance their existing careers and substantially improve the
          quality of life of those who are often discriminated against.
          Depending on your level of sponsorship, we will also list your logo
          and link on our website, thank you on Twitter, mention you in our
          monthly newsletter and you will be welcome to distribute your
          marketing collateral at our events. We look forward to welcoming you
